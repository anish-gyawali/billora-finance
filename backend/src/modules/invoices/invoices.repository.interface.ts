...
export interface IInvoicesRepository {
  ...
  void(id: string, actorId: string): Promise<InvoiceDetails>;
  recordPayment(id: string, input: CreatePaymentInput, actorId: string): Promise<{ invoice: InvoiceDetails; payment: Payment; paidAmount: Prisma.Decimal; status: Invoice["status"] }>;
